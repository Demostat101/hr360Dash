  ...
  return (
    <div className="w-full flex">
      ...
      <div className="w-[50%] h-screen flex justify-center place-items-center bg-[#F6F7FA]">
        {state === "login" ? (
          <>
            <div className="w-[60%] h-[600px] flex flex-col gap-[80px]">
                ...
                <div className="flex flex-col gap-[20px]">
                  <div className="flex flex-col gap-[10px]">
                    ...
                    <input
                      ...
                      className="h-[70px] bg-white rounded-[10px] pl-[20px] focus:outline-none"
                      type="email"
          ...
          <>
            <div className="w-[60%] h-[750px] flex flex-col gap-5">
