...
import DotImage from "../assets/logintopleft.jfif";
import Dot from "../assets/dot.jfif";
...
const Login = () => {
  ...
  return (
    <div className="w-full flex">
      <div className="w-[50%] h-screen bg-[#176B87] relative border-2 border-red-500 flex justify-center place-items-center">
...
<circle cx="131.504" cy="10.8932" r="7.5" transform="rotate(-25.3608 131.504 10.8932)" fill="#FEFEFE"/>
        ...
        <div className="text-center absolute bottom-0 text-white w-full">
          <span className="text-center">
            Sevenup Bottling Company 2024. All Rights Reserved.
          </span>
        </div>
      </div>
      <div className="w-[50%] h-screen border-2 border-yellow-500">logo</div>
    </div>
  );
};
