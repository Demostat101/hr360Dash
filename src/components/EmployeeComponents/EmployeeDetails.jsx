        ...
        <div className={open ? "w-full h-[208.08px] rounded-xl flex flex-col justify-center bg-white pl-[20px] shadow-md border-[1.75px] border-[#ECEEF6]" : "w-full h-[245.01px] rounded-xl flex flex-col justify-center bg-white pl-[20px] shadow-md border-[1.75px] border-[#ECEEF6]"}>
          
          {
            employeeFilter.map((employee)=>{
              return <div key={employee.id} className={open ? "w-[536.94px] h-[164.37px] flex gap-[10px] place-items-center" : "w-[589.17px] h-[180.35px] flex gap-[10.97px] place-items-center"}>
              ...
              <div className={open ? "w-[361.63px] h-[138px] " : "w-[396.94px] h-[150.38px]"}>
                <div className={open ? "w-[117px] h-[65px] p-[5px] flex flex-col gap-[10px]" : "w-[127.97px] h-[70.95px] p-[5.49px] flex flex-col gap-[10.97px]"}>
                  <h3 className={open ? "font-[600] text-[16px] leading-[24px] text-nowrap" : "font-[600] text-[17.56px] leading-[26.33px] text-nowrap"}>{employee.name}</h3>
                  <small className={open ? "font-[400] text-[14px] leading-[21px] text-black opacity-60 text-nowrap" : "font-[400] text-[15.36px] leading-[23.04px] text-black opacity-60 text-nowrap"}>{employee.job}</small>
                </div>
                ...
                <div className={open ? "w-full h-[73px] p-[5px] flex gap-[48px]" : "w-full h-[79px] p-[5.49px] flex gap-[52.67px]"}>
                  ...
                  <div className={open ? "w-[173.31px] h-[63px] flex flex-col gap-[15px]" : "w-[190.17px] h-[68.46px] flex flex-col gap-[16.46px]"}>
                    <div className={open ? "w-[157.31px] h-[24px] flex gap-[6px] place-items-center" : "w-[172.17px] h-[26px] flex gap-[6.58px] place-items-center"}> <MdEmail size={23} className="text-[#176B87] overflow-visible" /> <span className={open ? "font-[500] text-[16px] leading-[24px] text-black opacity-70" : "font-[500] text-[17.56px] leading-[26.33px] text-black opacity-70"}>{employee.email}</span> </div>
                    <div className={open ? "w-[173.31px] h-[24px] flex gap-[6px] place-items-center" : "w-[190.17px] h-[26px] flex gap-[6.58px] place-items-center"}> <FaPhone size={23} className="text-[#176B87]"/> <span className={open ? "font-[500] text-[16px] leading-[24px] text-black opacity-70" : "font-[500] text-[17.56px] leading-[26.33px] text-black opacity-70"}>{employee.phone}</span> </div>
                  </div>
