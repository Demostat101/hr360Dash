  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart barCategoryGap={15} data={halfsales} >
        <XAxis dataKey="month" tickLine={false} axisLine={{stroke:"#ECEEF6"}} tick={{fill:"black", fontSize:"13.96px", fontWeight:"500"} } />
        <YAxis tickLine={false} tick={false} width={1} axisLine={{stroke:"#ECEEF6"}}/>
        <Tooltip />
        <Legend />
